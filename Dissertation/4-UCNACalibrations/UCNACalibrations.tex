...
One last component that was left out of the above cyclical deiscussion is the determination of the position
...
\begin{figure} [p]
  ...
  \end{tabular}
  \caption{East linearity response curves for a single calibration run period in 2011-2012.}
...
\begin{figure} [p]
  ...
  \end{tabular}
  \caption{West linearity response curves for a single calibration run period in 2011-2012.}
