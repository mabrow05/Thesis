...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6,page=1]{3-UCNAAnalysis/mwpc_position.pdf} 
...
\begin{figure}[h]
  \centering
  \begin{tabular}{cc}
    \subfloat[East Detector]{\includegraphics[scale=0.37,page=2]{3-UCNAAnalysis/mwpc_position.pdf}} &
    \subfloat[West Detector]{\includegraphics[scale=0.37,page=3]{3-UCNAAnalysis/mwpc_position.pdf}}
    \end{tabular}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.5,page=7]{3-UCNAAnalysis/mwpc_position.pdf} 
...
\begin{figure}[h]
  \centering
  \begin{tabular}{cc}
  \subfloat[Multiplicity]{\includegraphics[scale=0.3,page=5]{3-UCNAAnalysis/mwpc_position.pdf}}  &
  \subfloat[Number of clipped wires]{\includegraphics[scale=0.3,page=4]{3-UCNAAnalysis/mwpc_position.pdf}}
  \end{tabular}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6,page=6]{3-UCNAAnalysis/mwpc_position.pdf} 
...
\section{Position Dependent Light Transport Maps} \label{sec:posmaps}
