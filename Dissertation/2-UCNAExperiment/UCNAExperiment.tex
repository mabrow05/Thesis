...
A schematic to assist in the understanding of the source is found in figure
...
from the cooling of the $\mathrm{SD}_2$ source in the cryostat. The UCN are produced when
a cold neutron enters the UCN source and excites a phonon in the superthermal $\mathrm{SD}_2$,
thereby losing the majority of its
energy \cite{golub1991ultra}.
