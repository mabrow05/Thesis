...
Prior to 1930, $\beta$-decay of nuclei, which at the time were thought to contain protons
...
In their 1956 paper \cite{leeyang1956}, Lee and Yang modified the weak interaction Hamiltonian
...
\iffalse
The motivation for such an idea was the observed universality between measurements of the Fermi constant ($G_F$)
from purely leptonic interactions and purely Fermi transitions (vector transitions).
The conservation of the vector current can be imagined by considering the dissociation of the neutron
...
the decay process is not allowed, then we would expect that the current would be modified.
...
the potentiality of neutron decay onto the dissociated pion \cite{grotz1990}. So, while one may na\"{i}vely
...
The remaining $f_3$ and $g_2$ couplings are called second-class currents \cite{weinberg1958charge}.
