...
usual $g_V$ and $g_A$ terms from the previous construction of the weak interaction. The other couplings
are referred to as induced terms, inferring that the hadronic current may be modified in ways other
than those captured by the axial vector and vector currents. The subscripts describe the type of
coupling (Scalar, Pseudoscalar, Tensor), and $g_{WM}$ accounts for weak magnetism as described by
Gell-Mann in 1958 \cite{gellmann1958}. Two of the terms, 
