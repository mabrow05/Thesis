...
spectra presented in this dissertation is currently under analysis by Xuan Sun of the California Institure of
...
\end{equation*}
where again $f_1(0)=g_V$ and $g_1(0)=g_A$, Gardner and Zhang report:
%
\begin{multline}
...
While neutrons have a magnetic moment and a mass, the typical energy scale
